...
const Card = ({ beer }) => {
    return (
        <div className="bg-gradient-to-br from-blue-400 to-purple-600 text-white rounded-lg shadow-md p-4 w-full mx-auto transition-transform transform hover:scale-105">
