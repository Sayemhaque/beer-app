...
const Card = ({ beer }) => {
    return (
       <section className="px-5">
        ...
        <div  className="h-full bg-gradient-to-br from-blue-400 to-purple-600 text-white rounded-lg shadow-md p-4 px-12 w-full mx-auto transition-transform transform hover:scale-105">
